            ...
            <div class="card-body">
              ...
              <form method='post' action='./backend/register_user.php'>
                ...
                <div class="col d-flex mb-2 justify-content-center">
                  ...
                  <div class="form-outline mt-4 mb-3" style="width:35%;">
                    <input type="integer" name="otp" id="formControlLg" class="form-control form-control-lg" placeholder="****" title="Please enter a phone number in the requested format" style="border-radius:.5rem">
                  <label class="form-label" for="formControlLg">Code</label>
                </div>
                  <button type="submit" name="otp_submit" id="login-button" class="btn btn-primary mx-1 mb-5">Confirm
                <span>
                  <?xml version="1.0" encoding="UTF-8"?>
                    <svg class="mb-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20pt" height="20pt" viewBox="0 0 900 899.99999" version="1.2">
                    <defs>
                  ...
                  <p class ="text-dark" id="register-link">Didn't receive a code?
                  <a href="loginform.php" style="text-decoration:none">Resend it</a></p>
                  <p class ="text-dark" id="register-link">Entered the wrong phone number?
